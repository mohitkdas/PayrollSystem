...
import org.example.payrollsystem.service.event.Event;
...
import org.example.payrollsystem.util.DateParserUtil;
...
public class PayrollService {
    ...
    private String validateEvent(String value, String fieldName) {
        ...
        if (fieldName == null) {
            if (value.equalsIgnoreCase("SALARY") || value.equalsIgnoreCase("BONUS") || value.equalsIgnoreCase("REIMBURSEMENT") || value.equalsIgnoreCase("EXIT")) {
                return value.trim();
            } else {
